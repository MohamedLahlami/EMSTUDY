      ...
      <ScrollView style={styles.content}>
        ...
        {diagnosticInfo && !isConnected && (
          <View style={styles.diagnosticContainer}>
            <Text style={styles.diagnosticTitle}>Informations de diagnostic</Text>
            <View style={styles.diagnosticItem}>
              <Text style={styles.diagnosticLabel}>URL utilisée:</Text>
              <Text style={styles.diagnosticValue}>{diagnosticInfo.baseUrl}</Text>
            </View>
            <View style={styles.diagnosticItem}>
            ...
            <View style={styles.diagnosticItem}>
              ...
              <Text style={styles.diagnosticValue}>{diagnosticInfo.customUrl ? 'Oui' : 'Non'}</Text>
            </View>
            {diagnosticInfo.error && (
              <View style={styles.diagnosticItem}>
                <Text style={styles.diagnosticLabel}>Erreur:</Text>
                <Text style={[styles.diagnosticValue, {color: '#d32f2f'}]}>{diagnosticInfo.error}</Text>
              </View>
            )}
            
            <Text style={styles.diagnosticTip}>
              Assurez-vous que:
            </Text>
            ...
            <Text style={styles.diagnosticDetail}>
              3. Votre appareil et serveur sont sur le même réseau 
               (ou utilisez l'URL correcte pour votre environnement)
            </Text>
          </View>
        )}
        ...
        <View style={styles.helpContainer}>
          ...
          <Text style={styles.helpText}>• En local (émulateur Android): http://10.0.2.2:8080</Text>
          <Text style={styles.helpText}>• En local (iOS simulator): http://localhost:8080</Text>
          <Text style={styles.helpText}>• Appareil physique: http://[IP_ORDINATEUR]:8080</Text>
          <Text style={styles.helpNote}>
            Assurez-vous que votre appareil et votre serveur sont sur le même réseau,
            et que le port 8080 n'est pas bloqué par un pare-feu.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
